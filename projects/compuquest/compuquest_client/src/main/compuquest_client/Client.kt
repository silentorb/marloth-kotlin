...
import silentorb.mythic.haft.newInputDeviceState
...
//    val newDeviceStates = silentorb.mythic.bloom.input.updateInputDeviceStates(platform.input, inputState.deviceStates)
//    state.copy(
